...
exports.isRestorableEqual = isRestorableEqual;
/**
 ...
 */
function isRestorableEqual(a, b) {
  ...
  return aKeys.every(key => Object.prototype.hasOwnProperty.call(b, key) && isRestorableEqual(a[key], b[key]));
}
