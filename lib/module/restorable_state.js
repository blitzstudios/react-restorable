 ...
 */
export function setRestorationEnabled(enabled) {
 ...
 */
export function configureRestorationScope(useScope) {
  useConfiguredScope = useScope;
}
export const restorationCounters = {
  manualRestored: 0,
  manualMissed: 0,
  pruned: 0
};
 ...
 */
export function setRestorationDebugEnabled(enabled) {
...
export function reportRestorationOnce(kind, dedupeOn, message) {
...
export function registerScopedStore(store) {
...
export function readRestorable(store, key) {
...
export function writeRestorable(store, key, value, generation = getRestorationGeneration(key)) {
  store.delete(key);
  store.set(key, {
    value,
    generation
...
const RestorationHiddenContext = /*#__PURE__*/createContext(null);
 ...
 */
export function RestorationHiddenBoundary({
  isHidden,
  children
}) {
  ...
  return /*#__PURE__*/_jsx(RestorationHiddenContext.Provider, {
    value: node,
    children: children
  });
}
...
export function isRestorationHidden(node) {
 ...
 */
export function getDetachReason(node, key, generationAtAttach) {
...
const testResets = [];
export function registerTestReset(reset) {
 ...
 */
export function pruneRestorableState(liveKeysByRoot) {
...
const RestorationNamespaceContext = /*#__PURE__*/createContext('');
...
export function useRestorableState(id, initialValue) {
...
export function forgetRestorableState(rootKey) {
...
export function seedRestorableStateForTests(scope, id, value) {
  restorationStore.set(`${scope}|${id}`, {
    value,
    generation: -1
  });
}
export function hasRestorableStateForTests(scope, id) {
