...
import { getIsRestorationDebugEnabled, registerTestReset } from "./restorable_state.js";
...
export function configureRestorationSnapshots(capture) {
  configured = capture;
}
...
export async function captureSnapshot(rootKey, place, view) {
...
export function peekSnapshot(rootKey, place, afterSequence = -1) {
...
export function discardRestorationSnapshots(rootKey) {
...
export function seedSnapshotForTests(rootKey, place, uri) {
